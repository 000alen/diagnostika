...
const exam2AtrialFibrillation = Exam.parse({
  ...
  description:
    "The patient arrives fatigued, feeling very weak and dizzy, with a slight sensation of vertigo. They also feel an irregular heartbeat, describing it as sharp, pounding beats with high frequency.",
});
...
const exam1AbdominalAorticAneurysm = Exam.parse({
  ...
  description:
    "The patient feels a throbbing sensation in the navel, also feels pain in the back and pain in the belly",
});
...
const exam2AbdominalAorticAneurysm = Exam.parse({
  ...
  description:
    "The patient suffered a rupture of the abdominal aorta, he did not present symptoms",
});
...
const exam1Hyperhidrosis = Exam.parse({
  ...
  description:
    "Abnormally excessive sweating involving the extremities, armpits, and face, due to excessive exercise",
});
...
const exam2Hyperhidrosis = Exam.parse({
  ...
  description:
    "The patient sweats very frequently, at least once a week, which causes them significant shame and anxiety. They believe this is disrupting their social life and overall quality of life.",
});
...
const exam1AbsenceSeizure = Exam.parse({
  ...
  description:
    "The patient is a 10-year-old child, very distracted at certain times, to the point of losing consciousness for brief moments.",
});
...
const exam2AbsenceSeizure = Exam.parse({
  ...
  description:
    "The child involuntarily makes small hand movements when lost in thought. Other notable observations include rapid blinking during this period of distraction.",
});
...
const exam3AbsenceSeizure = Exam.parse({
  ...
  description:
    "The patient exhibits a vacant stare and repetitive lip movements during periods of distraction.",
});
...
const exam1Achalasia = Exam.parse({
  ...
  description:
    "The patient has difficulty digesting their food, experiencing a sensation in the throat or esophagus that makes swallowing challenging.",
});
...
const exam2Achalasia = Exam.parse({
  ...
  description:
    "The patient reports chest pain, potentially caused by pressure in the esophagus. This same pain and discomfort trigger vomiting in the patient.",
});
...
const exam3Achalasia = Exam.parse({
  ...
  description:
    "The patient exhibits noticeable weight loss, continues to experience vomiting, and frequently regurgitates food, often accompanied by saliva.",
});
...
const testCase1 = Snapshot.parse({
  ...
  exams: [exam1AtrialFibrillation, exam2AtrialFibrillation],
});
...
const testCase2 = Snapshot.parse({
  ...
  exams: [exam1AbdominalAorticAneurysm],
});
...
const testCase3 = Snapshot.parse({
  ...
  exams: [exam1Hyperhidrosis, exam2Hyperhidrosis],
});
...
const testCase4 = Snapshot.parse({
  ...
  exams: [exam1AbsenceSeizure, exam2AbsenceSeizure, exam3AbsenceSeizure],
});
...
const testCase5 = Snapshot.parse({
  ...
  exams: [exam1Achalasia, exam2Achalasia, exam3Achalasia],
});
