...
import { ChevronDown, Plus, EllipsisVertical, Search } from 'lucide-react';

//
import { columns, users, statusOptions } from "../data/_patients_mock"
import { capitalize } from "@client/lib/utils";
import layout from "./patients.module.scss";
  ...
  return (
    <section className={layout.wrapper}>
      ...
      >
        ...
        <TableBody emptyContent={"No hay pacientes registrados aún"} items={sortedItems}>
          {(item) => (
